...
acc_hal_t acc_driver_hal_get_implementation(void)
{
	acc_hal_t hal =
	{
		...
		.sensor_device.is_interrupt_connected = acc_board_is_sensor_interrupt_connected,
		.sensor_device.is_interrupt_active = acc_board_is_sensor_interrupt_active,
		.sensor_device.register_isr = acc_board_register_isr,
