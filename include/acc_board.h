 ...
 *
 * If the function returns ACC_INTEGRATION_REGISTER_ISR_STATUS_OK, the interrupt service routine will be
 * triggered as soon as a sensor generates an interrupt.
 *
 ...
 * @return Status
 */
extern acc_integration_register_isr_status_t acc_board_register_isr(acc_board_isr_t isr);
