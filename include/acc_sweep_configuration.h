 ...
 * @return Sensor Id
 */
extern acc_sensor_id_t acc_sweep_configuration_sensor_get(const acc_sweep_configuration_t configuration);
 ...
 */
extern float acc_sweep_configuration_requested_start_get(const acc_sweep_configuration_t configuration);
 ...
 */
extern float acc_sweep_configuration_requested_length_get(const acc_sweep_configuration_t configuration);
 ...
 */
extern acc_sweep_configuration_power_save_mode_t acc_sweep_configuration_power_save_mode_get(const acc_sweep_configuration_t configuration);
 ...
 */
extern float acc_sweep_configuration_receiver_gain_get(const acc_sweep_configuration_t configuration);
 ...
 */
extern bool acc_sweep_configuration_tx_disable_get(const acc_sweep_configuration_t configuration);
 ...
 */
extern bool acc_sweep_configuration_decrease_tx_emission_get(const acc_sweep_configuration_t configuration);
